...
class MonthView extends ViewGroup implements OnClickListener, OnLongClickListener {

    protected static final int DEFAULT_DAYS_IN_WEEK = 7;
    protected static final int DEFAULT_MAX_WEEKS = 6;
    protected static final int DEFAULT_MONTH_TILE_HEIGHT = DEFAULT_MAX_WEEKS;
   ...
   /* 隐藏WeekDayView
    ...
    public boolean onLongClick(View v) {
        if (v instanceof DayView) {
            ...
            vibrator.vibrate(30);
            mcv.onDateLongClicked(dayView.getDate());
        }
        return true;
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            final int width = child.getMeasuredWidth() - child.getPaddingLeft();
            final int height = child.getMeasuredHeight() - child.getPaddingTop();

            child.layout(childLeft + 3, childTop + 6, childLeft + width, childTop + height);
