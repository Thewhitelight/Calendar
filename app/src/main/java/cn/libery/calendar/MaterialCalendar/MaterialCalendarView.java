...
import cn.libery.calendar.MaterialCalendar.format.ArrayWeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
  ...
  /*  private final OnClickListener onClickListener = new OnClickListener() {
    ...
    private OnDateLongChangedListener longListener;
...
/*      topbar = new LinearLayout(getContext());
   ...
   /* private void updateUi() {
     ...
     * depending on the visibility of the {@link #}.
     *
...
/*    public void setTitleFormatter(TitleFormatter titleFormatter) {
 ...
 /*   *//**
    ...
    *//**
    ...
    /**
     * Sets the visibility {@link #}, which contains
   ...
   */
    public boolean getTopbarVisible() {
        return false;// topbar.getVisibility() == View.VISIBLE;
    }

    public void setInvalidate() {
        invalidate();
        adapter.setInvalidate();
    }
    ...
    public void setOnDateLongChangedListener(OnDateLongChangedListener listener) {
    ...
    protected void dispatchOnDateLongClicked(CalendarDay day) {
        OnDateLongChangedListener l = longListener;
        if (l != null) {
            l.onDateLongChanged(MaterialCalendarView.this, day);
        }
    }
    ...
    protected void onDateLongClicked(CalendarDay date) {
        adapter.setDateSelected(date, true);
